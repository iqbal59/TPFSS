...
class Support_model extends MY_Model {
    ...
    public function washing_article_by_slug( $slug, $visibility )
    {
        // $select = 'a.*, ac.name as category_name, ac.slug as category_slug,';
        // $select .= 'ac.parent_id as category_parent_id';
        ...
        return $this->db->get('articles_washing')->row();;
    }
    ...
    public function chemical_articles( $article_id )
    {
       // $this->db->or_where_in( 'category_id', $ids );
        //$this->db->where( 'visibility', 1 );
        $this->db->where( 'washing_article_id =', $article_id );
       // $this->db->limit( 5 );
        
        $data = $this->db->get( 'article_washing_chemicals' );
