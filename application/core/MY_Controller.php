...
class MY_Controller extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->lang->load( ['global', 'errors', 'success', 'notifications', 'activities'] );
    ...
    protected function load_template( array $options )
    {
        ...
        $this->load->view(  "common/{$common_area}/header", [
        ...
        $this->load->view(  "{$area}/{$options['view']}", $options['data'] );
        
        $this->load->view(  "common/{$common_area}/footer", $options['data'] );
    }
