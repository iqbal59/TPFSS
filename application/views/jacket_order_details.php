...
<body>
                            ...
                            <div class="row gy-2 gx-3 align-items-center">
                                <div class="col-auto">
                                    ...
                                    <select id="date-column" class="form-select form-select-sm">
                                        ...
                                        <option value="5">Last Jacket Order</option>
                                        <option value="6">Jacket Order</option>
                                ...
                                <table class="table  text-center table-light table-striped" id="sp_table">
                                    <thead>
                                        <tr class="table-dark">
                                            ...
                                            <th scope="col" class="text-warning">Jacket Order (Before 1st Sep 2024)</th>
                                            <th scope="col">Jacket Order (After 1st Sep 2024)</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="status"
                                                    ...
                                                    <option value="YTC"
                                                        <?php echo $order->jacket_status == 'YTC' ? "selected" : ''; ?>>
                                                        Yet to Contact</option>
                                                    <option value="UF"
                                                        <?php echo $order->jacket_status == 'UF' ? "selected" : ''; ?>>
                                                        Under Followup</option>
                                                    <option value="OD"
                                                        <?php echo $order->jacket_order != null ? "selected" : ''; ?>>
                                                        Order
                                                        Given
                                                    </option>
                                                </select>
                                            ...
                                            <td><span id="<?php echo $order->id;?>">
                                                    ...
                                                    <?php if($order->jacket_status_time != null){echo date('d/m/Y H:i:s', strtotime($order->jacket_status_time)); }?>
                                                </span></td>
                                        </tr>
                                        <?php } ?>
    ...
    <div class="fixed-bottom bg-dark text-white">
        <div class="container p-3">
            <div class="row text-center">
                ...
                <div class="col-3">
                    <p class="mb-0"><strong>Jacket: </strong>
    ...
    function update_status(id, status) {
        ...
        // Make the API call
        $.ajax({
            url: '<?php echo base_url(); ?>' + 'api/customer_update_jacket_status/' + id + '/' + status,
            method: 'GET',
            dataType: "JSON",
            success: function(response) {
                // Update the modal's body with the response data
