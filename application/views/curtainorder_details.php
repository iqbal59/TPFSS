                                ...
                                <table class="table text-center table-light table-striped" id="sp_table">
                                    <thead>
                                        <tr class="table-dark">
                                            ...
                                            <th scope="col" class="text-warning">Curtain Order (Before 1st Sep 2024)
                                            </th>
                                            <th scope="col">Curtain Order (After 1st Sep 2024)</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="status"
                                                    ...
                                                    <option value="YTC"
                                                        <?php echo $order->curtain_status == 'YTC' ? "selected" : ''; ?>>
                                                        Yet to Contact</option>
                                                    <option value="UF"
                                                        <?php echo $order->curtain_status == 'UF' ? "selected" : ''; ?>>
                                                        Under Followup</option>
                                                    <option value="OD"
                                                        <?php echo $order->curtain_order != null ? "selected" : ''; ?>>
                                                        Order
                                                        Given
                                                    </option>
                                                </select>
                                            ...
                                            <td><span id="<?php echo $order->id;?>">
                                                    ...
                                                    <?php if($order->curtain_status_time != null){echo date('d/m/Y H:i:s', strtotime($order->curtain_status_time)); }?>
                                                </span></td>
                                        </tr>
                                        <?php } ?>
