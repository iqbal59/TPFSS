...
<body>
    ...
    <div class="content" style="padding:0 50px;">
        <p align="center"><strong>Ledger Period : <?php echo date("d-m-Y", strtotime($open_date));?>
                to
                <?php echo date("d-m-Y", strtotime($to_date));?></strong>
        </p>
        <div style="font-size:14px;">
            ...
            <b class="title_name"> <?php echo $storebalance['firm_name']?>
            </b>
            <BR />
        ...
        <table id="" class="list" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="right"><?php echo $total_balalnce=$storebalance['openbalance'];?>
                    </td>
...
foreach ($ledgerItems as $li) {?>
                ...
                <tr>
                    ...
                    <td class="right">
                        <?php if ($li['voucher_type']=='D' or $li['voucher_type']=='Sale') {
                                echo $li['np'];
                                $total_balalnce+=$li['np'];
                            }?>
                    </td>
                    <td class="right">
                        <?php if ($li['voucher_type']=='C' or $li['voucher_type']=='R') {
                                echo $li['np'];
                                $total_balalnce-=$li['np'];
                            }?>
                    </td>
                    ...
                    <td class="right"><?php echo $total_balalnce;?>
                    </td>
