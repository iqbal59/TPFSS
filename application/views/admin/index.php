                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="<?php echo base_url('admin/storenew') ?>"><i class="fa fa-angle-right"></i>
                                        Stores New</a></li>

                                <li><a href="<?php echo base_url('admin/store') ?>"><i class="fa fa-angle-right"></i>
                                        Stores</a></li>

                                <li><a href="<?php echo base_url('admin/accounts/ledgerblock') ?>"><i
                                            class="fa fa-angle-right"></i>
                                        Stores list for block</a></li>
                                <li><a href="<?php echo base_url('admin/store/blocktoggle') ?>"><i
                                            class="fa fa-angle-right"></i>
                                        Block/Unblock Store</a></li>
