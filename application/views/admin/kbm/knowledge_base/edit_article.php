...
<div class="content">
    <div class="container-fluid">
        <form class="z-form" action="<?php echo base_url( 'admin/kbm/support/update_article' ); ?>" method="post"
            data-csrf="manual">
            ...
            <div class="row">
                        ...
                        <div class="card-header d-flex align-items-center">
                            ...
                            <div class="card-tools ml-auto">
                                <a href="<?php echo env_url( get_kb_article_slug( html_escape( $article->slug ) ) ); ?>"
                                    class="btn text-sm btn-dark" target="_blank">
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="title"><?php echo lang( 'title' ); ?> <span
                                            class="required">*</span></label>
                                    <input type="text" id="title" class="form-control" name="title"
                                        value="<?php echo html_escape( $article->title ); ?>" required>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group col-md-6">
                                    <label for="slug">
                                    ...
                                    <input type="text" class="form-control" id="slug" name="slug"
                                        value="<?php echo html_escape( $article->slug ); ?>">
                                </div>
                                <!-- /.form-group -->
                            </div>
                            <!-- /.form-row -->
                            <div class="form-group">
                                <label for="textarea"><?php echo lang( 'content' ); ?> <span
                                        class="required">*</span></label>
                ...
                <div class="col-xl-3">
                        ...
                        <div class="card-body">
                            <div class="icheck icheck-primary d-inline-block mr-2">
                                <input type="radio" name="visibility" id="visibility-1" value="1"
                                    <?php echo check_single( 1, $article->visibility ); ?>>
                            ...
                            <div class="icheck icheck-primary d-inline-block">
                                <input type="radio" name="visibility" id="visibility-0" value="0"
                                    <?php echo check_single( 0, $article->visibility ); ?>>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo lang( 'category' ); ?> <span class="required">*</span>
                            </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <select class="form-control select2 search-disabled" id="category"
                                data-placeholder="<?php echo lang( 'select_category' ); ?>" name="category" required>
                                <option></option>
                ...
                foreach ( $categories as $category ) { ?>
                  ...
                  foreach ( $subcategories as $subcategory ) { ?>
                                <option value="<?php echo html_escape( $subcategory->id ); ?>"
