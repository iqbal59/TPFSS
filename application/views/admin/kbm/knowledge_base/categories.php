                    ...
                    <div class="card-header d-flex align-items-center">
                        ...
                        <div class="card-tools ml-auto">
                            <button class="btn btn-success text-sm" data-toggle="modal"
                                data-target="#add-articles-category">
                      ...
                      $id = $category->id; ?>
                                    <tr id="record-<?php echo html_escape( $id ); ?>">
                                        ...
                                        <td>
                                            ...
                                            <span
                                                class="text-muted text-sm d-block"><?php echo '/' . get_kb_category_slug( html_escape( $category->slug ) ); ?></span>
                                        </td>
                                        <td class="text-right">
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                <a href="<?php echo env_url( get_kb_category_slug( html_escape( $category->slug ) ) ); ?>"
