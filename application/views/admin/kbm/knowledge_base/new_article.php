...
<div class="content">
    <div class="container-fluid">
        <form class="z-form" action="<?php echo base_url( 'admin/kbm/support/add_article' ); ?>" method="post"
            data-csrf="manual">
            ...
            <div class="row">
                ...
                foreach ( $categories as $category ) { ?>
                  ...
                  foreach ( $subcategories as $subcategory ) { ?>
                                <option value="<?php echo html_escape( $subcategory->id ); ?>">&mdash;
                                    <?php echo html_escape( $subcategory->name ); ?></option>
                                <?php }
                } ?>
