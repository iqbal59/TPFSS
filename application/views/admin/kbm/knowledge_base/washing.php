                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center border-bottom-0">
                        ...
                        <div class="card-tools ml-auto">
                            <form action="<?php echo env_url( 'admin/knowledge_base/washing' ); ?>"
                    ...
                    <div class="card-header d-flex align-items-center">
                        ...
                        <div class="card-tools ml-auto">
                            <a class="btn btn-success text-sm"
                                href="<?php echo env_url( 'admin/knowledge_base/new_washing' ); ?>">
                                <i class="fas fa-plus-circle mr-2"></i> New Washing
                            </a>
                        </div>
                        <!-- /.card-tools -->
                    </div>
                    ...
                    foreach ( $articles as $article ) {
                      $id = $article->id; ?>
                                    <tr id="record-<?php echo html_escape( $id ); ?>">
                                        ...
                                        <td><?php echo html_escape( $article->garment_name ); ?></td>
                                        <!-- <td class="text-right">
                                            <?php
                          ...
                          ?>
                                        ...
                                        <td class="text-right">
                                            <?php manage_updated_at( html_escape( $article->updated_at ) ); ?></td>
                                        <td class="text-right">
                                            <?php echo get_date_time_by_timezone( html_escape( $article->created_at ) ); ?>
                                        </td>
                                        <td class="text-right">
                                            <div class="btn-group">
                                                <a href="<?php echo env_url('knowledge-base/washing-article/'.html_escape($article->slug)); ?>"
