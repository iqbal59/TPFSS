                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="date" name="from_date" class="form-control" placeholder="MM/DD/YYYY"
                                        required value="<?php if (!empty($search_query)) {
    ...
    echo date('Y-m-01');
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="date" name="to_date" class="form-control" placeholder="MM/DD/YYYY"
                                        required value="<?php if (!empty($search_query)) {
    ...
    echo date('Y-m-d');
                        ...
                        <div class="col-md-4">
                            <div class="form-group ">
                                <h5>Actions</h5>
                                <div class="controls">
                                    <button type="button" id="show_btn" class="btn btn-success">Show</button>
                                ...
                                <table id="table-voucher" class="table table-striped"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Amount</th>
                                            <th>Create Date</th>
                                            <th class="wrapword col-md-4">Descriptions</th>
