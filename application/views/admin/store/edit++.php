        ...
        <div class="col-lg-12">
            ...
            <div class="card card-outline-info">
                ...
                <div class="card-body">
                    ...
                    <div>
                        Paytm Mid1 :
                        <input type="text" name="paytm_mid1"
                    ...
                    <div>
                        Paytm Mid2 :
                        <input type="text" name="paytm_mid2"
                    ...
                    <div>
                        Paytm Mid3 :
                        <input type="text" name="paytm_mid3"
                    ...
                    <div>
                        Bharatpay Id :
                        <input type="text" name="bharatpay_id"
                    ...
                    <div>
                        Launch Date :
                        <input type="text" name="launch_date"
                    ...
                    <div>
                        Store Address :
                        <textarea
                            name="store_address"><?php echo($this->input->post('store_address') ? $this->input->post('store_address') : $store['store_address']); ?></textarea>
                    </div>
                    ...
                    <div>
                        GST State CODE :
                        <input type="text" name="gst_st_code"
