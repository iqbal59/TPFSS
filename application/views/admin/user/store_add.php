        ...
        <div class="col-lg-12">
            ...
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> Add New Store <a href="<?php echo base_url('admin/store/all_store_list') ?>" class="btn btn-info pull-right"><i class="fa fa-list"></i> All Users </a></h4>

                </div>
                <div class="card-body">
                    <form method="post" action="<?php echo base_url('admin/store/store_add') ?>" class="form-horizontal" novalidate>
                        <div class="form-body">
                            <br>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        <div class="col-md-5 offset-md-1 controls">
                                            <label>First Name</label>    
                                            <input type="text" name="first_name" class="form-control" required="" data-validation-required-message="First Name is required" aria-invalid="false">
                                            <div class="help-block"></div>
                                        </div>
                                        <div class="col-md-5 offset-md-1 controls">
                                            <label>Laste Name</label>
                                            <input type="text" name="first_names" class="form-control" required="" data-validation-required-message="last  Name is required" aria-invalid="false">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                </div>                                    
