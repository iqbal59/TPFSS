...
<form class="z-form" action="<?php echo base_url( 'admin/kbm/support/update_articles_category/sub' ); ?>" method="post">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            <label for="parent-category-edit"><?php echo lang( 'parent_category' ); ?> <span
                    class="required">*</span></label>
            <select class="form-control select2 search-disabled" id="parent-category-edit"
                data-placeholder="<?php echo lang( 'select_category' ); ?>" name="parent_category" required>
                <option></option>

                <?php if ( ! empty( $categories = get_articles_categories() ) ) {
          foreach ( $categories as $category ) { ?>
                <option value="<?php echo html_escape( $category->id ); ?>"
                    <?php echo select_single( $category->id, $parent_id ); ?>>
