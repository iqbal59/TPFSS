...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Credit Data</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Store Credit Data</li>
            </ol>
        </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="ledger_form" method="get" action="<?php echo base_url('admin/import/creditdata') ?>"
                            ...
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo date("d-m-Y", strtotime($s['refund_date'])); ?></td>
