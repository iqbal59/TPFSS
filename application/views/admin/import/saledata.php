        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="ledger_form" method="get" action="<?php echo base_url('admin/import/saledata') ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="date" name="from_date" class="form-control"
                                                ...
                                                value="<?php if(!empty($search_query)){ echo date('Y-m-d', strtotime($search_query['from_dt']));}?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="date" name="to_date" class="form-control"
                                                placeholder="MM/DD/YYYY" required
                                                value="<?php if(!empty($search_query)){ echo date('Y-m-d', strtotime($search_query['to_dt']));}?>">
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
