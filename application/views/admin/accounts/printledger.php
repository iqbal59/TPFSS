...
<body>
    ...
    <div class="content" style="padding:0 50px;">
        <p align="center"><strong>Ledger Period : <?php echo date("d-m-Y", strtotime($open_date));?> to
                <?php echo date("d-m-Y", strtotime($to_date));?></strong></p>
        ...
        <table id="" class="list" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="right"><?php echo $total_balalnce=$storebalance['openbalance'];?></td>
...
foreach($ledgerItems as $li){?>
                ...
                <tr>
                    ...
                    <td class="right">
                        <?php if($li['voucher_type']=='D' or $li['voucher_type']=='Sale'){echo $li['np'];$total_balalnce+=$li['np'];}?>
                    </td>
                    <td class="right">
                        <?php if($li['voucher_type']=='C' or $li['voucher_type']=='R'){echo $li['np'];$total_balalnce-=$li['np'];}?>
                    </td>
                    <td><?php echo  $li['descriptions'];?></td>
                    <td class="right"><?php echo $total_balalnce;?></td>
...
?>
            ...
            <tfoot>
                <tr>
                    ...
                    <th>-</th>
                    <th>-</th>
                    <th class="right"><strong><?php echo $total_balalnce;?></strong></th>
