                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col-12">
                            ...
                            <?php echo form_open_multipart('admin/storenew/add'); ?>
                                    ...
                                    <div class="row" style="padding:5px 15px;">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="partner_name" class="form-control form-control-sm"
                                                value="<?php echo set_value('partner_name'); ?>">
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-boby">
                                    <div class="row" style="padding:5px 15px;">
                                        <div class="form-group col-md-4">
                                            <label class="form-label" for="">Store Code
                                                <span class="text-red">(Tally Store Code)</span></label>

                                            <input type="text" name="store_code" placeholder="100"
                                                class="form-control form-control-sm"
                                                value="<?php echo set_value('store_code'); ?>">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="store_name" class="form-control form-control-sm"
                                                value="<?php echo set_value('store_name'); ?>">
                                            <span class="text-danger"><?php echo form_error('store_name'); ?></span>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="form-label" for="">Is FOFO</label>
                                            <select name="is_fofo" class="form-control form-control-sm" id="" value="">
                                                <option value="1" <?php echo set_select('is_fofo', '1'); ?>>Yes</option>
                                                <option value="2" <?php echo set_select('is_fofo', '2'); ?>>No</option>
                                            </select>
                                            <span class="text-danger"><?php echo form_error('is_fofo'); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="padding:0px 15px;">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="paytm_mid_1" class="form-control form-control-sm"
                                                value="<?php echo set_value('paytm_mid_1'); ?>">
                                            <span class="text-danger"><?php echo form_error('paytm_mid_1'); ?></span>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="form-label" for="">1st Pickup Slot<span
                                                    class="text-red"></span></label>
                                            <input type="time" name="first_pickup" class="form-control form-control-sm"
                                                value="<?php echo set_value('first_pickup'); ?>">
                                            <span class="text-danger"><?php echo form_error('first_pickup'); ?></span>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="form-label" for="">Last Pickup Slot<span
                                                    class="text-red"></span></label>
                                            <input type="time" name="last_pickup" class="form-control form-control-sm"
                                                value="<?php echo set_value('last_pickup'); ?>">
                                            <span class="text-danger"><?php echo form_error('last_pickup'); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="padding:0px 15px;">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="str_manager_name"
                                                class="form-control form-control-sm"
                                                value="<?php echo set_value('str_manager_name'); ?>">
                                            <span
                                                class="text-danger"><?php echo form_error('str_manager_name'); ?></span>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="form-label" for="">TSM Name<span
                                                    class="text-red"></span></label>
                                            <input type="text" name="tsm_name" class="form-control form-control-sm"
                                                value="<?php echo set_value('tsm_name'); ?>">
                                            <span class="text-danger"><?php echo form_error('tsm_name'); ?></span>
                                        </div>

                                        <div class="form-group col-md-4">
                                            <label class="form-label" for="">Store Address</label>
                                            <input type="text" name="str_address" class="form-control form-control-sm"
                                                value="<?php echo set_value('str_address'); ?>">
                                            <span class="text-danger"><?php echo form_error('str_address'); ?></span>
                                        </div>
                                    ...
                                    <div class="row" style="padding:0px 15px;">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="store_city" class="form-control form-control-sm"
                                                value="<?php echo set_value('store_city'); ?>">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="store_state" id="state" class="form-control form-control-sm"
                                                ...
                                                <option value="<?php echo $value->id; ?>"
                                                    <?php echo set_select('store_state', $value->id); ?>>
                                                    <?php echo $value->name; ?>
                                                </option>
                                                <?php
                                                    }
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="str_pin_code" class="form-control form-control-sm"
                                                value="<?php echo set_value('str_pin_code'); ?>">
                                            <span class="text-danger"><?php echo form_error('str_pin_code'); ?></span>
                                        </div>
                                ...
                                <div class="panel-boby">
                                    ...
                                    <div class="row" style="padding:5px 15px;">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="firm_name" class="form-control form-control-sm"
                                                value="<?php echo set_value('firm_name'); ?>">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="firm_gst_regis_type" class="form-control form-control-sm"
                                                value="">
                                                <option value="">Select</option>
                                                <option value="1" <?php echo set_select('firm_gst_regis_type', '1'); ?>>
                                                    GST</option>
                                                <option value="2" <?php echo set_select('firm_gst_regis_type', '2'); ?>>
                                                    Non GST
                                                </option>
                                            </select>
                                            <span
                                                class="text-danger"><?php echo form_error('firm_gst_regis_type'); ?></span>
                                        </div>
                                        <div class="form-group col-md-4">
                                    ...
                                    <div class="row" style="padding:0px 15px;">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="firm_pan_no" class="form-control form-control-sm"
                                                value="<?php echo set_value('firm_pan_no'); ?>">
                                            <span class="text-danger"><?php echo form_error('firm_pan_no'); ?></span>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="form-label" for="">Firm Address<span
                                                    class="text-red"></span></label>
                                            <input type="text" name="firm_address" class="form-control form-control-sm"
                                                value="<?php echo set_value('firm_address'); ?>">
                                            <span class="text-danger"><?php echo form_error('firm_address'); ?></span>
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="firm_city" class="form-control form-control-sm"
                                                value="<?php echo set_value('firm_city'); ?>">
                                            <span class="text-danger"><?php echo form_error('firm_city'); ?></span>
                                        </div>
                                    ...
                                    <div class="row" style="padding:0px 15px;">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="firm_state" id="state" class="form-control form-control-sm"
                                                ...
                                                <?php
                                                    foreach ($states as $value) {
                                                        ?>
                                                <option value="<?php echo $value->id; ?>"
                                                    <?php echo set_select('firm_state', $value->id); ?>>
                                                    <?php echo $value->name; ?>
                                                </option>
                                                <?php
                                                    }
                                            ...
                                            <!-- <input type="text" name="store_state" class="form-control form-control-sm" value=""> -->
                                            <span class="text-danger"><?php echo form_error('firm_state'); ?></span>
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="firm_pin_code" class="form-control form-control-sm"
                                                value="<?php echo set_value('firm_pin_code'); ?>">
                                            <span class="text-danger"><?php echo form_error('firm_pin_code'); ?></span>
                                        </div>
                                    ...
                                    <div class="row" style="padding:0px 15px;">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" name="franchise_agreement_date"
                                                class="form-control form-control-sm"
                                                value="<?php echo set_value('franchise_agreement_date'); ?>">
                                            <span
                                                class="text-danger"><?php echo form_error('franchise_agreement_date'); ?></span>
                                        </div>
                                    </div>
                                    <div class="row" style="padding:0px 15px;">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="file" name="cancelled_cheque"
                                                class="form-control form-control-sm"
                                                value="<?php echo set_value('cancelled_cheque'); ?>">
                                ...
                                <div class="panel-boby">
                                    ...
                                    <div class="table-responsive mt-4 ">
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody id="tableBody">
                                                <!-- Existing rows or empty if none -->
                                            </tbody>
                                        </table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control"
                                                        name="extrainfo[<?php echo $i;?>][field_name]"></td>
                                                <td><input type="text" class="form-control"
                                                        name="extrainfo[<?php echo $i;?>][field_value]"></td>
