        ...
        <div class="album bg-light">
            <div class="container">
                ...
                <div class="row row-cols-1 equal-cols row-cols-sm-2 row-cols-md-3 g-3 mb-4">
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm" onclick="window.open('home/viewbyaadhar', '_blank');">
                            <img src="<?php echo base_url('assets/images/manpower.png') ?>" class="card-img-top" />

                            <div class="card-body">


                                <h5 class="card-title">Manpower Service Record Hub</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Aadhar-Based Employee Background Verification
                                </h6>

                                <p class="card-text">Enter the Aadhar number to validate the employee's training details
                                    and employment history, including salary and role. This enables you to make informed
                                    hiring decisions.</p>
