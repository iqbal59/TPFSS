...
<div class="modal close-after" id="add-articles-subcategory">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form class="z-form" action="<?php echo base_url('admin/kbm/support/add_articles_category/sub'); ?>"
                method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="parent-category-add"><?php echo lang( 'parent_category' ); ?> <span
                                class="required">*</span></label>
                        <select class="form-control select2 search-disabled" id="parent-category-add"
